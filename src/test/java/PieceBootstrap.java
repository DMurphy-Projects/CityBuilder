...
public class PieceBootstrap {
    ...
    public static void main(String[] args) throws IOException, TransformerException, ParserConfigurationException {
        ...
        CityTile[] tiles = new CityTile[]{
                new CityTile("ROAD", 2, 4),
                new CityTile("TURN", 4, 4),
                new CityTile("JUNCTION", 4, 4),
                new CityTile("INTERSECTION", 1, 4),
                new CityTile("BLANK", 1, 4),
                new CityTile("BUILDING", 1, 4),
        };
        ...
        for (CityTile tile: tiles)
        {
            ...
            for (int i=0;i<4;i++) {
                tileHandler.add(tile.getBaseId(), i, i % tile.getRotation());
            }
        }
